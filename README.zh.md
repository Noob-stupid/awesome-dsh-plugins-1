...
| # | 插件 | 描述 | ⭐ |
|---|---|---|---|
| 🥇 | [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | 官方核心仓库：「一切皆插件」，Cordis 驱动 | 152468 |
| 🥈 | [deepseek-harness-desktop](https://github.com/anywhere-labs/deepseek-harness-desktop) | 现代化 DeepSeek Harness 桌面端体验 | 12139 |
| 🥉 | [awesome-dsh-plugin/awesome-dsh-plugin](https://github.com/awesome-dsh-plugin/awesome-dsh-plugin) | 社区精选列表（105 插件 + 站点 + 徽章） | 7802 |
| 4 | [deepseek-ai/awesome-deepseek-agent](https://github.com/deepseek-ai/awesome-deepseek-agent) | 官方 Agent 精选列表 | 5914 |
| 5 | [dsh-web-ui](https://github.com/zhu1090093659/dsh-web-ui) | DSH Web UI 插件与皮肤集合：任务看板、Git 图谱、右侧面板、移动端远程、皮肤中心 | 4213 |
| 6 | [modlens](https://github.com/liustack/modlens) | DSH 首个视觉插件：粘贴图片返回结构化 JSON 证据（OCR/布局/语义） | 2862 |
| 7 | [DSH-better-sidebar](https://github.com/omdsh-dev/DSH-better-sidebar) | 侧边栏完整工作台：文件渲染编辑/终端/Git/子代理，支持三方注册 Tab | 2004 |
| 8 | [dsh-TUI](https://github.com/ccch1mneyyy/dsh-TUI) | Claude Code 风格全屏交互终端：像素鲸鱼顶栏、流式思考展开、双击 Esc 回滚、上下文/TPS 仪表 | 1850 |
| 9 | [deepseek-pp](https://github.com/zhu1090093659/deepseek-pp) | 浏览器扩展 AI Agent 工作区，内置 MCP 与记忆 | 1589 |
| 10 | [dsh-deep-whale](https://github.com/Small-tailqwq/dsh-deep-whale) | DSH Web 鲸鱼娘皮肤系列（深海女仆工坊） | 1268 |
...
| [dsh-at-file](https://github.com/omdsh-dev/dsh-at-file) | 344 | Codex 风格 `@file` 文件引用，输入框里直接搜索并引用工作区文件 | `dsh plugin add dsh-at-file` |
...
| [dsh-data-agent](https://github.com/omdsh-dev/dsh-data-agent) | 51 | 让 AI 帮你连数据库、写 SQL | `dsh plugin add @deepseek-ai/dsh-data-agent` |
...
| 插件 | ⭐ | 描述 | 安装命令 |
|---|---|---|---|
| [dsh-mcp-manager](https://github.com/hyqhyq3/dsh-mcp-manager) | 8 | MCP 服务器管理：Settings 页 OAuth(PKCE) 或静态 token 认证，工具注册为 `mcp__*` | `dsh plugin add dsh-mcp-manager` |
...
| [dsh-deep-whale](https://github.com/Small-tailqwq/dsh-deep-whale) | 1268 | DSH Web 鲸鱼娘皮肤系列（深海女仆工坊） |  |
| [dsh-qq2006](https://github.com/LaplaceYoung/dsh-qq2006) | 14 | QQ2006 复古皮肤 |  |
...
| [dsh-deepcel](https://github.com/Small-tailqwq/dsh-deepcel) | 11 | 模仿 Excel 的皮肤 |  |
...
| [deepseek-harness-skin](https://github.com/HeiGeAi/deepseek-harness-skin) | 45 | 换肤系统：21 套内置皮肤 + 一图生成整套配色 |  |
...
| [DSH-better-sidebar](https://github.com/omdsh-dev/DSH-better-sidebar) | 2004 | 侧边栏完整工作台：文件渲染编辑/终端/Git/子代理，支持三方注册 Tab | `dsh plugin add dsh-better-sidebar` |
...
| [dsh-navbar](https://github.com/vlln/dsh-navbar) | 38 | 对话节点导航条，右缘节点串快速跳转 user 消息 | `dsh plugin add @dsh-external/dsh-navbar` |
...
| [dsh-spotlight](https://github.com/0xsline/dsh-spotlight) | 8 | 键盘优先的命令面板（command palette） | `dsh plugin add @dsh-external/dsh-spotlight` |
...
| [dsh-diff-viewer](https://github.com/lehhair/dsh-diff-viewer) | 18 | PiUI 风格 diff 查看器，替换 write/edit 的默认 DiffBlock | `dsh plugin add @dsh-external/dsh-diff-viewer` |
| [dsh-drag-and-drop](https://github.com/bill9109/dsh-drag-and-drop) | 16 | 跨平台文件拖拽与原始路径插入，无需复制文件 | `dsh plugin add @bill9109/dsh-drag-and-drop` |
| [ex-setting](https://github.com/omdsh-dev/ex-setting) | 2 | DSH 的设置扩展 | `dsh plugin add @deepseek-ai/dsh-ex-setting` |
| [dsh-annotation](https://github.com/omdsh-dev/dsh-annotation) | 72 | 选中文字→批注→回车随消息发送，回复按批注逐条对照 | `dsh plugin add @omdsh-dev/dsh-annotation` |
...
| [dsh-web-ui](https://github.com/zhu1090093659/dsh-web-ui) | 4213 | DSH Web UI 插件与皮肤集合：任务看板、Git 图谱、右侧面板、移动端远程、皮肤中心 | `dsh plugin add dsh-web-ui` |
...
| [dsh-visualize](https://github.com/Nagi-ovo/dsh-visualize) | 170 | 对话内生成式 UI：模型把交互式 HTML 卡片直接画进会话流，带流式预览 | `dsh plugin add @dsh-external/dsh-visualize` |
| [dsh-genui](https://github.com/omdsh-dev/dsh-genui) | 193 | 助手回复内渲染交互式 UI 组件：布局、图表、表单、测验、mermaid、3D 场景 | `dsh plugin add @omdsh-dev/dsh-genui` |
...
| [dsh-openpencil](https://github.com/ZSeven-W/dsh-openpencil) | 111 | OpenPencil 设计预览与编辑（Agent 操作真实设计画布） | `dsh plugin add @zseven-w/dsh-openpencil` |
...
| 插件 | ⭐ | 描述 | 安装命令 |
|---|---|---|---|
| [dsh-TUI](https://github.com/ccch1mneyyy/dsh-TUI) | 1850 | Claude Code 风格全屏交互终端：像素鲸鱼顶栏、流式思考展开、双击 Esc 回滚、上下文/TPS 仪表 | `dsh plugin add dsh-cc-tui` |
| [dsh-tianshu-tui](https://github.com/huiliyi37/dsh-tianshu-tui) | 208 | DSH 终端 TUI（天枢） | `dsh plugin add @huiliyi37/dsh-tianshu-tui` |
...
| [oh-dsh](https://github.com/hust-open-atom-club/oh-dsh) | 244 | 一站式社区发行版：TUI、桌面端与 Web UI 三种形态统一体验 | `dsh plugin add @oh-dsh/desktop` |
...
| [dsh-desktop](https://github.com/bruc3van/dsh-desktop) | 57 | 社区维护的非官方桌面客户端（复用官方实例或内置运行时） |  |
...
| [dsh-desktop](https://github.com/dataelement/dsh-desktop) | 814 | 跨平台桌面应用 |  |
...
| [deepseek-harness-desktop](https://github.com/anywhere-labs/deepseek-harness-desktop) | 12139 | 现代化 DeepSeek Harness 桌面端体验 |  |
| [Deepseek-Harness-Desktop](https://github.com/ChisaAlter/Deepseek-Harness-Desktop) | 111 | Electron 桌面壳：主题/背景图/托盘，对话仍走官方 dsh web | `dsh plugin add deepseek-harness-desktop` |
| [dsh-launcher](https://github.com/Ruler4396/dsh-launcher) | 135 | Windows 轻量启动器：开机自启 + 独立小窗口 |  |
| [dsh-work](https://github.com/vibeinging/deepseek-harness-desktop-app) | 385 | 本地 AI 工作桌面：Session/文件/数据分析/MCP/Office 一体化 |  |
...
| [dsh-mobile](https://github.com/lehhair/dsh-mobile) | 18 | 移动端客户端（⚠️ dsh-external，公开性待核实） |  |
| [dsh-android](https://github.com/dsh-external/dsh-android) |  | 在 Android 上运行 dsh（⚠️ dsh-external，已删除） |  |
| [deepseek-harness-tui](https://github.com/openma-ai/deepseek-harness-tui) | 38 | Rust/ratatui 编写的 DSH 终端 TUI | `dsh plugin add github:openma-ai/deepseek-harness-tui` |
...
| 插件 | ⭐ | 描述 | 安装命令 |
|---|---|---|---|
| [dsh-agent-teams](https://github.com/NanmiCoder/dsh-agent-teams) | 503 | AgentTeams 多智能体团队协作 | `dsh plugin add dsh-agent-teams` |
| [dsh_workflow](https://github.com/icetomoyo/dsh_workflow) | 76 | 把 UltraCode 式多 Agent 调度带给 DSH：可生成/保存/治理/观察/恢复的 Workflow 层 | `dsh plugin add @dsh-external/workflow` |
...
| 插件 | ⭐ | 描述 | 安装命令 |
|---|---|---|---|
| [dsh-memory-evolve](https://github.com/csyangwen/dsh-memory-evolve) | 158 | 跨会话长期记忆 + 后台自我进化（五轨记忆/git 分支感知/技能进化） |  |
| [billion-context-dsh](https://github.com/Tyan66666/billion-context-dsh) | 22 | 模型驱动上下文压缩（ACP）：模型决定何时压缩（移植自 billion-context-pi） |  |
...
| [dsh-mnemon](https://github.com/omdsh-dev/dsh-mnemon) | 76 | Mnemon 本地三层记忆（Runtime Memory/可检索文档/受监督 Memory Spaces） | `dsh plugin add dsh-mnemon` |
...
| [dsh-context](https://github.com/bowenliang123/dsh-context) | 231 | 上下文洞察面板：展示模型上下文窗口的构成与演化 | `dsh plugin add dsh-context` |
| [dsh-turn-rewind](https://github.com/Anionex/dsh-turn-rewind) | 77 | 对话回退：基于持久 Change Ledger 回滚会话与工作区状态 | `dsh plugin add @dsh-external/turn-rewind` |
...
| 插件 | ⭐ | 描述 | 安装命令 |
|---|---|---|---|
| [modlens](https://github.com/liustack/modlens) | 2862 | DSH 首个视觉插件：粘贴图片返回结构化 JSON 证据（OCR/布局/语义） | `dsh plugin add @liustack/modlens` |
| [dsh-vision-toolkit](https://github.com/Anionex/dsh-vision-toolkit) | 640 | 纯文本模型的视觉工具箱：图片问答、长截图 OCR、UI 还原、定位、像素对比、Artifacts | `dsh plugin add @dsh-external/dsh-vision-toolkit` |
| [agent-vision-toolkit](https://github.com/Anionex/agent-vision-toolkit) | 1006 | 同上，agent 通用视觉工具箱与技能（多图理解/GUI 自动化） |  |
| [dsh-vision](https://github.com/william-jin-cmu/dsh-vision) | 34 | view_image 工具桥接任意 OpenAI 兼容 VLM（默认智谱免费档） |  |
...
| [dsh-vision-router](https://github.com/ysr666/dsh-vision-router) | 658 | 纯文本模型的视觉路由：免费视觉链 + 像素级视觉工具（问答/定位/裁剪/OCR） | `dsh plugin add dsh-vision-router` |
...
| [dsh-automation](https://github.com/titanwings/dsh-automation) | 52 | 定时任务：Coding 任务按计划在全新 Agent Session 中运行 | `dsh plugin add @dsh-external/dsh-automation` |
...
| [dsh-record-replay](https://github.com/humblebanana/dsh-record-replay) | 9 | 录制 macOS 桌面工作流演示并转成 agent 技能（orr_* 工具） | `dsh plugin add dsh-record-replay` |
...
| [dsh-notification](https://github.com/omdsh-dev/dsh-notification) | 59 | 回合完成桌面通知，按结果分控 + 关键词过滤 | `dsh plugin add dsh-notification` |
...
| [dsh-web-ui-notify](https://github.com/bill9109/dsh-web-ui-notify) | 18 | 桌面通知提醒 | `dsh plugin add @bill9109/dsh-web-ui-notify` |
| [dsh-session-notification](https://github.com/dingyi222666/dsh-session-notification) | 13 | 会话完成等四种状态通知，支持浏览器提示 | `dsh plugin add @dingyi222666/dsh-session-notification` |
...
| 插件 | ⭐ | 描述 | 安装命令 |
|---|---|---|---|
| [dsh-browser](https://github.com/Lum1104/dsh-browser) | 261 | Chrome 侧边栏扩展，让 DSH 直接操作你的浏览器（无需视觉能力） |  |
...
| [ego-browser](https://github.com/Fisfzy/ego-browser) | 23 | 把 ego-lite（给 AI Agent 的 Chromium）接入 DSH，13 个结构化 ego_* 工具 |  |
...
| [deepseek-pp](https://github.com/zhu1090093659/deepseek-pp) | 1589 | 浏览器扩展 AI Agent 工作区，内置 MCP 与记忆 |  |
...
| [dsh-web-search-pro](https://github.com/anweat/dsh-web-search-pro) | 22 | 增强持久搜索（多引擎 + SQLite/LRU 缓存 + Playwright 渲染） | `dsh plugin add dsh-web-search-pro` |
| [dsh-all-search](https://github.com/RealAlexandreAI/dsh-all-search) | 1 | AnySearch 网页搜索提供方（ctx.web） | `dsh plugin add dsh-all-search` |
| [modsearch](https://github.com/liustack/modsearch) | 135 | CLI 搜索工具：把搜索查询转结构化 web 证据 JSON | `dsh plugin add @liustack/modsearch` |
| [argo](https://github.com/taxueseek/argo) | 98 | 为 agent 打造的多语言搜索工具（中文/英文/学术/代码/购物/金融/新闻/百科） | `dsh plugin add github:taxueseek/argo` |
...
| [dsh-super-injector](https://github.com/yjh051108/dsh-super-injector) | 99 | 超级模组注入器：运行时注入本地插件包（junction + loader.create，热重载） | `dsh plugin add @dsh-external/dsh-super-injector` |
...
| [dsh-openai-codex-auth](https://github.com/yoke233/dsh-openai-codex-auth) | 6 | OpenAI Codex OAuth 登录与用量卡 | `dsh plugin add dsh-openai-codex-auth` |
...
| [dsh-market](https://github.com/dsh-market/dsh-market) | 867 | DSH 可视化插件市场：浏览/搜索/一键安装 | `dsh plugin add github:dsh-market/dsh-market` |
| [dsh-webui-market-plugin](https://github.com/Sanqi-normal/dsh-webui-market-plugin) | 79 | dsh Web GUI 社区插件市场：浏览 awesome-dsh-plugin 目录/安装/卸载 | `dsh plugin add github:Sanqi-normal/dsh-webui-market-plugin` |
...
| [whale-girl](https://github.com/vlln/whale-girl) | 225 | 桌面宠物鲸鱼娘（QQ 宠物形态，可拖拽/投喂/玩耍） | `dsh plugin add whale-girl` |
...
| [dsh-ads](https://github.com/Nagi-ovo/dsh-ads) | 485 | 2005 中文站点风格整活广告（侧栏/信息流/弹窗，素材全虚构） | `dsh plugin add @dsh-external/dsh-ads` |
...
| [dsh-cost-meter](https://github.com/Han-1413141/dsh-cost-meter) | 80 | DSH 会话费用统计（本会话/当日/历史 + 官方价格同步） | `dsh plugin add github:Han-1413141/dsh-cost-meter` |
...
| 插件 | ⭐ | 描述 | 安装命令 |
|---|---|---|---|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | 152468 | 官方核心仓库：「一切皆插件」，Cordis 驱动 |  |
| [deepseek-ai/awesome-deepseek-agent](https://github.com/deepseek-ai/awesome-deepseek-agent) | 5914 | 官方 Agent 精选列表 |  |
| [awesome-dsh-plugin/awesome-dsh-plugin](https://github.com/awesome-dsh-plugin/awesome-dsh-plugin) | 7802 | 社区精选列表（105 插件 + 站点 + 徽章） |  |
| [bruc3van/awesome-dsh-plugin](https://github.com/bruc3van/awesome-dsh-plugin) | 212 | 「30 秒找到适合你的插件」，带场景说明 + 505 全量快照 |  |
| [0xsline/awesome-deepseek-harness](https://github.com/0xsline/awesome-deepseek-harness) | 699 | DSH 生态精选：插件/工具/基础设施 |  |
| [AdamPlatin123/awesome-dsh-plugins](https://github.com/AdamPlatin123/awesome-dsh-plugins) | 1158 | 目录 + **每日兼容性雷达**（四维检查 + 运行实测） |  |
...
| [HenryZ838978/deepseek-harness](https://github.com/HenryZ838978/deepseek-harness) | 44 | 第三方 Harness：Python 库 + dsh CLI + MCP server + SKILL.md |  |
