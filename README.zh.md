...
| # | 插件 | 描述 | ⭐ |
|---|---|---|---|
| 🥇 | [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | 官方核心仓库：「一切皆插件」，Cordis 驱动 | 154007 |
| 🥈 | [deepseek-harness-desktop](https://github.com/anywhere-labs/deepseek-harness-desktop) | 现代化 DeepSeek Harness 桌面端体验 | 12422 |
| 🥉 | [awesome-dsh-plugin/awesome-dsh-plugin](https://github.com/awesome-dsh-plugin/awesome-dsh-plugin) | 社区精选列表（105 插件 + 站点 + 徽章） | 7944 |
| 4 | [deepseek-ai/awesome-deepseek-agent](https://github.com/deepseek-ai/awesome-deepseek-agent) | 官方 Agent 精选列表 | 5917 |
| 5 | [dsh-web-ui](https://github.com/zhu1090093659/dsh-web-ui) | DSH Web UI 插件与皮肤集合：任务看板、Git 图谱、右侧面板、移动端远程、皮肤中心 | 4285 |
| 6 | [modlens](https://github.com/liustack/modlens) | DSH 首个视觉插件：粘贴图片返回结构化 JSON 证据（OCR/布局/语义） | 2916 |
| 7 | [DSH-better-sidebar](https://github.com/omdsh-dev/DSH-better-sidebar) | 侧边栏完整工作台：文件渲染编辑/终端/Git/子代理，支持三方注册 Tab | 2037 |
| 8 | [dsh-TUI](https://github.com/ccch1mneyyy/dsh-TUI) | Claude Code 风格全屏交互终端：像素鲸鱼顶栏、流式思考展开、双击 Esc 回滚、上下文/TPS 仪表 | 1879 |
| 9 | [deepseek-pp](https://github.com/zhu1090093659/deepseek-pp) | 浏览器扩展 AI Agent 工作区，内置 MCP 与记忆 | 1590 |
| 10 | [dsh-deep-whale](https://github.com/Small-tailqwq/dsh-deep-whale) | DSH Web 鲸鱼娘皮肤系列（深海女仆工坊） | 1282 |
...
| [dsh-at-file](https://github.com/omdsh-dev/dsh-at-file) | 352 | Codex 风格 `@file` 文件引用，输入框里直接搜索并引用工作区文件 | `dsh plugin add dsh-at-file` |
...
| [dsh-data-agent](https://github.com/omdsh-dev/dsh-data-agent) | 52 | 让 AI 帮你连数据库、写 SQL | `dsh plugin add @deepseek-ai/dsh-data-agent` |
...
| [dsh-reverse-skill](https://github.com/dhicoc/dsh-reverse-skill) | 30 | 逆向工程、授权渗透测试与安全研究技能路由包（85 个 SKILL.md，仅限授权测试） | `dsh plugin add github:dhicoc/dsh-reverse-skill` |
| [dsh-find-plugins](https://github.com/Nagi-ovo/dsh-find-plugins) | 140 | 帮 DSH 搜索、安装并验证 GitHub 插件的 Skill | `dsh plugin add github:Nagi-ovo/dsh-find-plugins` |
...
| 插件 | ⭐ | 描述 | 安装命令 |
|---|---|---|---|
| [dsh-mcp-manager](https://github.com/hyqhyq3/dsh-mcp-manager) | 9 | MCP 服务器管理：Settings 页 OAuth(PKCE) 或静态 token 认证，工具注册为 `mcp__*` | `dsh plugin add dsh-mcp-manager` |
...
| [mcp-bridge](https://github.com/WongJingGitt/mcp-bridge) | 31 | MCP 浏览器桥接，让网页端 AI 调用 MCP 工具 |  |
...
| [dsh-deep-whale](https://github.com/Small-tailqwq/dsh-deep-whale) | 1282 | DSH Web 鲸鱼娘皮肤系列（深海女仆工坊） |  |
...
| [deepseek-harness-skin](https://github.com/HeiGeAi/deepseek-harness-skin) | 46 | 换肤系统：21 套内置皮肤 + 一图生成整套配色 |  |
...
| [DSH-better-sidebar](https://github.com/omdsh-dev/DSH-better-sidebar) | 2037 | 侧边栏完整工作台：文件渲染编辑/终端/Git/子代理，支持三方注册 Tab | `dsh plugin add dsh-better-sidebar` |
...
| [dsh-web-ui](https://github.com/zhu1090093659/dsh-web-ui) | 4285 | DSH Web UI 插件与皮肤集合：任务看板、Git 图谱、右侧面板、移动端远程、皮肤中心 | `dsh plugin add dsh-web-ui` |
...
| [dsh-visualize](https://github.com/Nagi-ovo/dsh-visualize) | 171 | 对话内生成式 UI：模型把交互式 HTML 卡片直接画进会话流，带流式预览 | `dsh plugin add @dsh-external/dsh-visualize` |
| [dsh-genui](https://github.com/omdsh-dev/dsh-genui) | 199 | 助手回复内渲染交互式 UI 组件：布局、图表、表单、测验、mermaid、3D 场景 | `dsh plugin add @omdsh-dev/dsh-genui` |
...
| [dsh-openpencil](https://github.com/ZSeven-W/dsh-openpencil) | 115 | OpenPencil 设计预览与编辑（Agent 操作真实设计画布） | `dsh plugin add @zseven-w/dsh-openpencil` |
...
| 插件 | ⭐ | 描述 | 安装命令 |
|---|---|---|---|
| [dsh-TUI](https://github.com/ccch1mneyyy/dsh-TUI) | 1879 | Claude Code 风格全屏交互终端：像素鲸鱼顶栏、流式思考展开、双击 Esc 回滚、上下文/TPS 仪表 | `dsh plugin add dsh-cc-tui` |
| [dsh-tianshu-tui](https://github.com/huiliyi37/dsh-tianshu-tui) | 210 | DSH 终端 TUI（天枢） | `dsh plugin add @huiliyi37/dsh-tianshu-tui` |
...
| [oh-dsh](https://github.com/hust-open-atom-club/oh-dsh) | 246 | 一站式社区发行版：TUI、桌面端与 Web UI 三种形态统一体验 | `dsh plugin add @oh-dsh/desktop` |
...
| [dsh-desktop](https://github.com/bruc3van/dsh-desktop) | 56 | 社区维护的非官方桌面客户端（复用官方实例或内置运行时） |  |
...
| [dsh-desktop](https://github.com/dataelement/dsh-desktop) | 846 | 跨平台桌面应用 |  |
...
| [deepseek-harness-desktop](https://github.com/anywhere-labs/deepseek-harness-desktop) | 12422 | 现代化 DeepSeek Harness 桌面端体验 |  |
| [Deepseek-Harness-Desktop](https://github.com/ChisaAlter/Deepseek-Harness-Desktop) | 113 | Electron 桌面壳：主题/背景图/托盘，对话仍走官方 dsh web | `dsh plugin add deepseek-harness-desktop` |
| [dsh-launcher](https://github.com/Ruler4396/dsh-launcher) | 136 | Windows 轻量启动器：开机自启 + 独立小窗口 |  |
| [dsh-work](https://github.com/vibeinging/deepseek-harness-desktop-app) | 392 | 本地 AI 工作桌面：Session/文件/数据分析/MCP/Office 一体化 |  |
...
| 插件 | ⭐ | 描述 | 安装命令 |
|---|---|---|---|
| [dsh-agent-teams](https://github.com/NanmiCoder/dsh-agent-teams) | 514 | AgentTeams 多智能体团队协作 | `dsh plugin add dsh-agent-teams` |
| [dsh_workflow](https://github.com/icetomoyo/dsh_workflow) | 78 | 把 UltraCode 式多 Agent 调度带给 DSH：可生成/保存/治理/观察/恢复的 Workflow 层 | `dsh plugin add @dsh-external/workflow` |
...
| 插件 | ⭐ | 描述 | 安装命令 |
|---|---|---|---|
| [dsh-memory-evolve](https://github.com/csyangwen/dsh-memory-evolve) | 164 | 跨会话长期记忆 + 后台自我进化（五轨记忆/git 分支感知/技能进化） |  |
| [billion-context-dsh](https://github.com/Tyan66666/billion-context-dsh) | 23 | 模型驱动上下文压缩（ACP）：模型决定何时压缩（移植自 billion-context-pi） |  |
...
| [dsh-mnemon](https://github.com/omdsh-dev/dsh-mnemon) | 82 | Mnemon 本地三层记忆（Runtime Memory/可检索文档/受监督 Memory Spaces） | `dsh plugin add dsh-mnemon` |
...
| [dsh-context](https://github.com/bowenliang123/dsh-context) | 234 | 上下文洞察面板：展示模型上下文窗口的构成与演化 | `dsh plugin add dsh-context` |
| [dsh-turn-rewind](https://github.com/Anionex/dsh-turn-rewind) | 78 | 对话回退：基于持久 Change Ledger 回滚会话与工作区状态 | `dsh plugin add @dsh-external/turn-rewind` |
...
| 插件 | ⭐ | 描述 | 安装命令 |
|---|---|---|---|
| [modlens](https://github.com/liustack/modlens) | 2916 | DSH 首个视觉插件：粘贴图片返回结构化 JSON 证据（OCR/布局/语义） | `dsh plugin add @liustack/modlens` |
| [dsh-vision-toolkit](https://github.com/Anionex/dsh-vision-toolkit) | 653 | 纯文本模型的视觉工具箱：图片问答、长截图 OCR、UI 还原、定位、像素对比、Artifacts | `dsh plugin add @dsh-external/dsh-vision-toolkit` |
| [agent-vision-toolkit](https://github.com/Anionex/agent-vision-toolkit) | 1014 | 同上，agent 通用视觉工具箱与技能（多图理解/GUI 自动化） |  |
...
| [dsh-vision-router](https://github.com/ysr666/dsh-vision-router) | 677 | 纯文本模型的视觉路由：免费视觉链 + 像素级视觉工具（问答/定位/裁剪/OCR） | `dsh plugin add dsh-vision-router` |
...
| [dsh-llm-fallbacks](https://github.com/omdsh-dev/dsh-llm-fallbacks) | 8 | 基于角色的模型重试/备用策略 | `dsh plugin add dsh-llm-fallbacks` |
...
| 插件 | ⭐ | 描述 | 安装命令 |
|---|---|---|---|
| [dsh-browser](https://github.com/Lum1104/dsh-browser) | 268 | Chrome 侧边栏扩展，让 DSH 直接操作你的浏览器（无需视觉能力） |  |
...
| [ego-browser](https://github.com/Fisfzy/ego-browser) | 24 | 把 ego-lite（给 AI Agent 的 Chromium）接入 DSH，13 个结构化 ego_* 工具 |  |
...
| [deepseek-pp](https://github.com/zhu1090093659/deepseek-pp) | 1590 | 浏览器扩展 AI Agent 工作区，内置 MCP 与记忆 |  |
...
| [modsearch](https://github.com/liustack/modsearch) | 138 | CLI 搜索工具：把搜索查询转结构化 web 证据 JSON | `dsh plugin add @liustack/modsearch` |
...
| 插件 | ⭐ | 描述 | 安装命令 |
|---|---|---|---|
| [plugin-registry](https://github.com/vlln/plugin-registry) | 55 | 插件管理控制台：浏览器面板管理官方 repository 插件 + 开发引导 |  |
...
| [dsh-super-injector](https://github.com/yjh051108/dsh-super-injector) | 101 | 超级模组注入器：运行时注入本地插件包（junction + loader.create，热重载） | `dsh plugin add @dsh-external/dsh-super-injector` |
...
| [dsh-market](https://github.com/dsh-market/dsh-market) | 901 | DSH 可视化插件市场：浏览/搜索/一键安装 | `dsh plugin add github:dsh-market/dsh-market` |
| [dsh-webui-market-plugin](https://github.com/Sanqi-normal/dsh-webui-market-plugin) | 82 | dsh Web GUI 社区插件市场：浏览 awesome-dsh-plugin 目录/安装/卸载 | `dsh plugin add github:Sanqi-normal/dsh-webui-market-plugin` |
...
| [whale-girl](https://github.com/vlln/whale-girl) | 226 | 桌面宠物鲸鱼娘（QQ 宠物形态，可拖拽/投喂/玩耍） | `dsh plugin add whale-girl` |
...
| [deepseek-pet](https://github.com/keleus/deepseek-pet) | 30 | 在 DSH 上养一只大蓝鲸 | `dsh plugin add deepseek-pet` |
...
| [dsh-ads](https://github.com/Nagi-ovo/dsh-ads) | 486 | 2005 中文站点风格整活广告（侧栏/信息流/弹窗，素材全虚构） | `dsh plugin add @dsh-external/dsh-ads` |
| [dsh-stock-market](https://github.com/AnacondaKC/dsh-stock-market) | 15 | 股票行情数据插件（整活向） | `dsh plugin add dsh-stock-market` |
| [dsh-douyin](https://github.com/AnacondaKC/dsh-douyin) | 4 | 侧栏短视频：原生播放器、系列导航、历史回放 | `dsh plugin add dsh-douyin` |
...
| [dsh-openmaic](https://github.com/THU-MAIC/dsh-openmaic) | 14 | OpenMAIC 教学：课堂、幻灯片、交互组件、苏格拉底式教学 | `dsh plugin add @openmaic/dsh-openmaic` |
| [dsh-scholar](https://github.com/lzszq/dsh-scholar) | 23 | 学术助手插件 | `dsh plugin add @dsh-scholar/research-plugin` |
...
| [notes](https://github.com/zhaoolee/notes) | 146 | 开源版锤子便签：导出 DSH 会话为便签图片，支持 skill 调用 ⚠️ 无 license 文件 |  |
| [dsh-cost-meter](https://github.com/Han-1413141/dsh-cost-meter) | 85 | DSH 会话费用统计（本会话/当日/历史 + 官方价格同步） | `dsh plugin add github:Han-1413141/dsh-cost-meter` |
...
| 插件 | ⭐ | 描述 | 安装命令 |
|---|---|---|---|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | 154007 | 官方核心仓库：「一切皆插件」，Cordis 驱动 |  |
| [deepseek-ai/awesome-deepseek-agent](https://github.com/deepseek-ai/awesome-deepseek-agent) | 5917 | 官方 Agent 精选列表 |  |
| [awesome-dsh-plugin/awesome-dsh-plugin](https://github.com/awesome-dsh-plugin/awesome-dsh-plugin) | 7944 | 社区精选列表（105 插件 + 站点 + 徽章） |  |
| [bruc3van/awesome-dsh-plugin](https://github.com/bruc3van/awesome-dsh-plugin) | 215 | 「30 秒找到适合你的插件」，带场景说明 + 505 全量快照 |  |
| [0xsline/awesome-deepseek-harness](https://github.com/0xsline/awesome-deepseek-harness) | 707 | DSH 生态精选：插件/工具/基础设施 |  |
| [AdamPlatin123/awesome-dsh-plugins](https://github.com/AdamPlatin123/awesome-dsh-plugins) | 1170 | 目录 + **每日兼容性雷达**（四维检查 + 运行实测） |  |
