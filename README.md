...
| [dsh-plugin-mineru](https://github.com/HuanLinOTO/dsh-plugin-mineru) | 24 | Expose MineRU document parsing tools to the model. | `dsh plugin add @huanlin/dsh-plugin-mineru` |
...
| [dsh-annotation](https://github.com/omdsh-dev/dsh-annotation) | 54 | Select text → annotate → send with your message; replies map back to each annotation. | `dsh plugin add @omdsh-dev/dsh-annotation` |
...
| [oh-dsh](https://github.com/hust-open-atom-club/oh-dsh) | 193 | Community distribution: TUI, desktop, and Web UI as one bundle with layered installation. | `dsh plugin add @oh-dsh/desktop` |
...
| [dsh-super-injector](https://github.com/yjh051108/dsh-super-injector) | 71 | Super module injector: inject local plugin packages at runtime (junction + loader.create, hot reload). | `dsh plugin add @dsh-external/dsh-super-injector` |
...
| [dsh-toy](https://github.com/c3ll256/dsh-toy) | 46 | Connect small toys to DSH (Toy Control Protocol). | `dsh plugin add dsh-toy` |
