...
| # | Plugin | Description | ⭐ |
|---|---|---|---|
| 🥇 | [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | Official core repo: "everything is a plugin", driven by Cordis. | 164132 |
| 🥈 | [deepseek-harness-desktop](https://github.com/anywhere-labs/deepseek-harness-desktop) | Modern DeepSeek Harness desktop experience | 14484 |
| 🥉 | [awesome-dsh-plugin/awesome-dsh-plugin](https://github.com/awesome-dsh-plugin/awesome-dsh-plugin) | Community curated list (105 plugins + sites + badges). | 9589 |
| 4 | [deepseek-ai/awesome-deepseek-agent](https://github.com/deepseek-ai/awesome-deepseek-agent) | Official curated list of DeepSeek agents. | 5946 |
| 5 | [dsh-web-ui](https://github.com/zhu1090093659/dsh-web-ui) | DSH Web UI plugin and skin collection: task board, Git graph, right panel, mobile remote, skin center | 4756 |
| 6 | [modlens](https://github.com/liustack/modlens) | Vision bridge for text-only models: paste an image, get structured JSON evidence (OCR, layout, semantics). | 3207 |
| 7 | [DSH-better-sidebar](https://github.com/omdsh-dev/DSH-better-sidebar) | Full sidebar workbench with file rendering and editing, terminal, Git, and subagents; third-party plugins can register new tabs. | 2270 |
| 8 | [dsh-TUI](https://github.com/ccch1mneyyy/dsh-TUI) | Claude Code-style full-screen terminal UI: pixel-whale header, live status line, and streaming thought expansion. | 2036 |
| 9 | [deepseek-pp](https://github.com/zhu1090093659/deepseek-pp) | Browser-extension AI agent workspace with built-in MCP and memory | 1616 |
| 10 | [dsh-deep-whale](https://github.com/Small-tailqwq/dsh-deep-whale) | Whale-girl skin series for the DSH Web UI (maid-atelier). | 1423 |
...
| [dsh-at-file](https://github.com/omdsh-dev/dsh-at-file) | 400 | Codex-style `@file` mentions: search workspace files in the composer and attach their contents to prompts. | `dsh plugin add dsh-at-file` |
...
| [dsh-cowork](https://github.com/Jesse-njx/dsh-cowork) | 5 | Bounded, cell-addressed `doc_read`/`doc_write` for xlsx / pdf / docx / pptx / ipynb, plus an MCP server and CLI. |  |
...
| [dsh-reverse-skill](https://github.com/dhicoc/dsh-reverse-skill) | 40 | Complete reverse-skill pack (85 SKILL.md) as a DeepSeek Harness Cordis plugin: reverse engineering, authorized pentesting and security-research skill router. | `dsh plugin add github:dhicoc/dsh-reverse-skill` |
| [dsh-find-plugins](https://github.com/Nagi-ovo/dsh-find-plugins) | 151 | Skill that searches, installs, and verifies GitHub plugins for DSH | `dsh plugin add github:Nagi-ovo/dsh-find-plugins` |
...
| [mcp-bridge](https://github.com/WongJingGitt/mcp-bridge) | 32 | MCP browser bridge enabling web AI to call MCP tools |  |
...
| [dsh-deep-whale](https://github.com/Small-tailqwq/dsh-deep-whale) | 1423 | Whale-girl skin series for the DSH Web UI (maid-atelier). |  |
...
| [DSH-better-sidebar](https://github.com/omdsh-dev/DSH-better-sidebar) | 2270 | Full sidebar workbench with file rendering and editing, terminal, Git, and subagents; third-party plugins can register new tabs. | `dsh plugin add dsh-better-sidebar` |
...
| [dsh-navbar](https://github.com/vlln/dsh-navbar) | 44 | Conversation node navigation bar for quick jumps between user messages. | `dsh plugin add @dsh-external/dsh-navbar` |
...
| [TokenLedger](https://github.com/zh667/TokenLedger) | 105 | Track local DSH token usage by relay site, project and model, and show account balance and subscription quota cycles. |  |
...
| [dsh-web-ui](https://github.com/zhu1090093659/dsh-web-ui) | 4756 | DSH Web UI plugin and skin collection: task board, Git graph, right panel, mobile remote, skin center | `dsh plugin add dsh-web-ui` |
...
| [dsh-genui](https://github.com/omdsh-dev/dsh-genui) | 234 | Interactive UI components rendered inline in replies: layout, charts, forms, quizzes, mermaid, 3D scenes, and an action event loop back to the model. | `dsh plugin add @omdsh-dev/dsh-genui` |
...
| Plugin | ⭐ | Description | Install |
|---|---|---|---|
| [dsh-TUI](https://github.com/ccch1mneyyy/dsh-TUI) | 2036 | Claude Code-style full-screen terminal UI: pixel-whale header, live status line, and streaming thought expansion. | `dsh plugin add dsh-cc-tui` |
...
| [oh-dsh](https://github.com/hust-open-atom-club/oh-dsh) | 256 | Community distribution: TUI, desktop, and Web UI as one bundle with layered installation. | `dsh plugin add @oh-dsh/desktop` |
...
| [dsh-desktop](https://github.com/bruc3van/dsh-desktop) | 62 | Community-maintained unofficial desktop client (reuse official instance or built-in runtime) |  |
...
| [dsh-desktop](https://github.com/dataelement/dsh-desktop) | 1020 | Cross-platform desktop app |  |
...
| [deepseek-harness-desktop](https://github.com/anywhere-labs/deepseek-harness-desktop) | 14484 | Modern DeepSeek Harness desktop experience |  |
| [Deepseek-Harness-Desktop](https://github.com/ChisaAlter/Deepseek-Harness-Desktop) | 121 | Electron desktop shell with themes, wallpapers, and tray; chat stays on official dsh web | `dsh plugin add deepseek-harness-desktop` |
| [dsh-launcher](https://github.com/Ruler4396/dsh-launcher) | 150 | Lightweight Windows launcher: auto-start on boot + standalone small window |  |
...
| Plugin | ⭐ | Description | Install |
|---|---|---|---|
| [dsh-agent-teams](https://github.com/NanmiCoder/dsh-agent-teams) | 590 | AgentTeams multi-agent teams. | `dsh plugin add dsh-agent-teams` |
| [dsh_workflow](https://github.com/icetomoyo/dsh_workflow) | 85 | UltraCode-style multi-agent orchestration: a generatable, savable, governable, observable, resumable workflow layer. | `dsh plugin add @dsh-external/workflow` |
...
| Plugin | ⭐ | Description | Install |
|---|---|---|---|
| [dsh-memory-evolve](https://github.com/csyangwen/dsh-memory-evolve) | 188 | Cross-session long-term memory plus background self-evolution (five-track memory, git branch awareness, skill evolution) |  |
...
| [dsh-mnemon](https://github.com/omdsh-dev/dsh-mnemon) | 117 | Deep Mnemon integration: local three-tier memory (Runtime Memory, retrievable Documents, supervised Memory Spaces). | `dsh plugin add dsh-mnemon` |
...
| [dsh-continual-evolve](https://github.com/ZK-Andy/dsh-continual-evolve) | 14 | Continual self-evolution: versioned, auditable, rollback-safe harness state (prompts, memory, skills, subagent specs) refined from session trajectories, with review gates and hot-reloaded skills. | `dsh plugin add dsh-continual-evolve` |
...
| [dsh-context](https://github.com/bowenliang123/dsh-context) | 421 | Context insight panel: see what the model's context window is made of and how it evolves — composition vs. window size, per-request history, compression/injection events, and per-message token stats. | `dsh plugin add dsh-context` |
| [dsh-turn-rewind](https://github.com/Anionex/dsh-turn-rewind) | 84 | Rewind conversation and workspace state, powered by a persistent Change Ledger. | `dsh plugin add @dsh-external/turn-rewind` |
...
| Plugin | ⭐ | Description | Install |
|---|---|---|---|
| [modlens](https://github.com/liustack/modlens) | 3207 | Vision bridge for text-only models: paste an image, get structured JSON evidence (OCR, layout, semantics). | `dsh plugin add @liustack/modlens` |
| [dsh-vision-toolkit](https://github.com/Anionex/dsh-vision-toolkit) | 729 | Vision tasks for text-only models: intent-aware image Q&A, long-screenshot OCR, UI reproduction, grounding, and pixel diff. | `dsh plugin add @dsh-external/dsh-vision-toolkit` |
| [agent-vision-toolkit](https://github.com/Anionex/agent-vision-toolkit) | 1057 | General agent vision toolkit and skills (multi-image understanding and GUI automation) |  |
...
| [dsh-vision-router](https://github.com/ysr666/dsh-vision-router) | 797 | Free vision for text-only agents: built-in keyless vision chain plus pixel tools (Q&A, grounding, crop, pixel diff, colors, OCR, SVG trace, cutout, screenshots); paste an image to use it. | `dsh plugin add dsh-vision-router` |
...
| [dsh-automation](https://github.com/titanwings/dsh-automation) | 62 | Scheduled coding runs in fresh agent sessions with auditable history. | `dsh plugin add @dsh-external/dsh-automation` |
...
| [dsh-im](https://github.com/xmanrui/dsh-im) | 58 | One settings entry to connect Feishu/WeChat/DingTalk/WeCom/QQ/Slack/Telegram/Discord/WhatsApp bots via QR scan, App Manifest or credentials. |  |
| [dsh-notification](https://github.com/omdsh-dev/dsh-notification) | 63 | Desktop notifications for turn completions, with per-outcome controls and keyword rules. | `dsh plugin add dsh-notification` |
...
| [dsh-share](https://github.com/hellodigua/dsh-share) | 28 | Share your conversations with one click. | `dsh plugin add @dsh-external/dsh-share` |
...
| Plugin | ⭐ | Description | Install |
|---|---|---|---|
| [dsh-browser](https://github.com/Lum1104/dsh-browser) | 310 | Chrome sidebar extension that lets DSH operate your browser directly, no vision capabilities required. |  |
...
| [deepseek-pp](https://github.com/zhu1090093659/deepseek-pp) | 1616 | Browser-extension AI agent workspace with built-in MCP and memory |  |
...
| [modsearch](https://github.com/liustack/modsearch) | 163 | Web search bridge for text-only agents: ask the web or X, get structured JSON evidence (search, fetch, citations). | `dsh plugin add @liustack/modsearch` |
| [argo](https://github.com/taxueseek/argo) | 103 | Search built for agents: multilingual coverage across web, academic, code, shopping, finance, news, and encyclopedias. | `dsh plugin add github:taxueseek/argo` |
...
| [dsh-super-injector](https://github.com/yjh051108/dsh-super-injector) | 120 | Super module injector: inject local plugin packages at runtime (junction + loader.create, hot reload). | `dsh plugin add @dsh-external/dsh-super-injector` |
| [oh-my-dsh](https://github.com/LaplaceYoung/oh-my-dsh) | 49 | Plugin ecosystem for DSH: 700+ plugins with extension seams registered without touching the agent loop. |  |
...
| [dsh-passwords](https://github.com/slywalker2006/dsh-passwords) | 12 | Login gateway for the DSH web UI: password door with first-run setup, bcrypt + at-rest encryption (AES-256-GCM/HMAC), brute-force lockout, audit log, TLS 1.2+ with 80→443 redirect, CSRF, anti-framing. | `dsh plugin add github:slywalker2006/dsh-passwords` |
...
| [dsh-multica-runtime](https://github.com/multica-ai/dsh-multica-runtime) | 50 | Multica DSH runtime bridge (stdio JSONL protocol). | `dsh plugin add @multica-ai/dsh-runtime` |
...
| [dsh-market](https://github.com/dsh-market/dsh-market) | 1153 | The plugin market inside DSH: a Settings page to browse and search the full community catalog by category, with confirmed one-click installs and an installed-plugins view. | `dsh plugin add github:dsh-market/dsh-market` |
...
| [whale-girl](https://github.com/vlln/whale-girl) | 243 | Desktop pet (QQ-pet style): floats in the corner, draggable, feedable, playable. | `dsh plugin add whale-girl` |
...
| [deepseek-pet](https://github.com/keleus/deepseek-pet) | 33 | Keep a big blue whale pet in DSH. | `dsh plugin add deepseek-pet` |
...
| [dsh-emoji](https://github.com/hellodigua/dsh-emoji) | 28 | Automatically add emojis to AI replies. | `dsh plugin add @dsh-external/dsh-emoji` |
| [dsh-ads](https://github.com/Nagi-ovo/dsh-ads) | 506 | Parody ads in 2005-Chinese-web style: sidebar banners, in-chat feeds, corner popups, and a close button whose hit area is smaller than it looks. All fictional. | `dsh plugin add @dsh-external/dsh-ads` |
...
| [dsh-cost-meter](https://github.com/Han-1413141/dsh-cost-meter) | 104 | Per-session and daily API cost, budget with usage %, official balance, history dashboard, and one-click official price sync with peak/off-peak pricing. | `dsh plugin add github:Han-1413141/dsh-cost-meter` |
...
| Plugin | ⭐ | Description | Install |
|---|---|---|---|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | 164132 | Official core repo: "everything is a plugin", driven by Cordis. |  |
| [deepseek-ai/awesome-deepseek-agent](https://github.com/deepseek-ai/awesome-deepseek-agent) | 5946 | Official curated list of DeepSeek agents. |  |
| [awesome-dsh-plugin/awesome-dsh-plugin](https://github.com/awesome-dsh-plugin/awesome-dsh-plugin) | 9589 | Community curated list (105 plugins + sites + badges). |  |
| [bruc3van/awesome-dsh-plugin](https://github.com/bruc3van/awesome-dsh-plugin) | 241 | "Find your plugin in 30 seconds", with scenario descriptions and a 505-plugin snapshot. |  |
| [0xsline/awesome-deepseek-harness](https://github.com/0xsline/awesome-deepseek-harness) | 741 | Curated DSH ecosystem: plugins, tools, and infrastructure. |  |
| [AdamPlatin123/awesome-dsh-plugins](https://github.com/AdamPlatin123/awesome-dsh-plugins) | 1235 | Catalog plus a daily compatibility radar (four-dimension checks + live tests). |  |
