...
| # | Plugin | Description | ⭐ |
|---|---|---|---|
| 🥇 | [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | Official core repo: "everything is a plugin", driven by Cordis. | 164986 |
| 🥈 | [deepseek-harness-desktop](https://github.com/anywhere-labs/deepseek-harness-desktop) | Modern DeepSeek Harness desktop experience | 14712 |
| 🥉 | [awesome-dsh-plugin/awesome-dsh-plugin](https://github.com/awesome-dsh-plugin/awesome-dsh-plugin) | Community curated list (105 plugins + sites + badges). | 9786 |
| 4 | [deepseek-ai/awesome-deepseek-agent](https://github.com/deepseek-ai/awesome-deepseek-agent) | Official curated list of DeepSeek agents. | 5949 |
| 5 | [dsh-web-ui](https://github.com/zhu1090093659/dsh-web-ui) | DSH Web UI plugin and skin collection: task board, Git graph, right panel, mobile remote, skin center | 4799 |
| 6 | [modlens](https://github.com/liustack/modlens) | Vision bridge for text-only models: paste an image, get structured JSON evidence (OCR, layout, semantics). | 3229 |
| 7 | [DSH-better-sidebar](https://github.com/omdsh-dev/DSH-better-sidebar) | Full sidebar workbench with file rendering and editing, terminal, Git, and subagents; third-party plugins can register new tabs. | 2289 |
| 8 | [dsh-TUI](https://github.com/ccch1mneyyy/dsh-TUI) | Claude Code-style full-screen terminal UI: pixel-whale header, live status line, and streaming thought expansion. | 2052 |
| 9 | [deepseek-pp](https://github.com/zhu1090093659/deepseek-pp) | Browser-extension AI agent workspace with built-in MCP and memory | 1625 |
| 10 | [dsh-deep-whale](https://github.com/Small-tailqwq/dsh-deep-whale) | Whale-girl skin series for the DSH Web UI (maid-atelier). | 1437 |
...
| [dsh-at-file](https://github.com/omdsh-dev/dsh-at-file) | 407 | Codex-style `@file` mentions: search workspace files in the composer and attach their contents to prompts. | `dsh plugin add dsh-at-file` |
...
| [dsh-data-agent](https://github.com/omdsh-dev/dsh-data-agent) | 62 | Let the AI connect to databases and write SQL for you. | `dsh plugin add @deepseek-ai/dsh-data-agent` |
...
| [dsh-find-plugins](https://github.com/Nagi-ovo/dsh-find-plugins) | 153 | Skill that searches, installs, and verifies GitHub plugins for DSH | `dsh plugin add github:Nagi-ovo/dsh-find-plugins` |
| [forkprobe](https://github.com/Jayden-X-L/forkprobe) | 68 | Compare multiple skills on the same task and pick the winner. | `dsh plugin add github:Jayden-X-L/forkprobe` |
...
| [dsh-deep-whale](https://github.com/Small-tailqwq/dsh-deep-whale) | 1437 | Whale-girl skin series for the DSH Web UI (maid-atelier). |  |
...
| [deepseek-harness-skin](https://github.com/HeiGeAi/deepseek-harness-skin) | 48 | Skinning system with 21 built-in skins plus one-image color scheme generation |  |
...
| [DSH-better-sidebar](https://github.com/omdsh-dev/DSH-better-sidebar) | 2289 | Full sidebar workbench with file rendering and editing, terminal, Git, and subagents; third-party plugins can register new tabs. | `dsh plugin add dsh-better-sidebar` |
...
| [dsh-annotation](https://github.com/omdsh-dev/dsh-annotation) | 78 | Select text → annotate → send with your message; replies map back to each annotation. | `dsh plugin add @omdsh-dev/dsh-annotation` |
...
| [dsh-prompt-persona](https://github.com/Xilin3/dsh-prompt-persona) | 9 | Edit the system prompt (deployment persona) from settings with live preview | `dsh plugin add @xilin3/dsh-prompt-persona` |
...
| [TokenLedger](https://github.com/zh667/TokenLedger) | 108 | Track local DSH token usage by relay site, project and model, and show account balance and subscription quota cycles. |  |
...
| [dsh-model-config-sync](https://github.com/LiangYin233/dsh-provider-model-configurator) | 10 | Advanced model configurator applying pi-ai presets to custom providers in one click | `dsh plugin add dsh-model-config-sync` |
| [dsh-web-ui](https://github.com/zhu1090093659/dsh-web-ui) | 4799 | DSH Web UI plugin and skin collection: task board, Git graph, right panel, mobile remote, skin center | `dsh plugin add dsh-web-ui` |
...
| [dsh-visualize](https://github.com/Nagi-ovo/dsh-visualize) | 184 | In-conversation generative UI: the model renders interactive HTML cards into the chat stream, with streaming preview and sandboxed rendering. | `dsh plugin add @dsh-external/dsh-visualize` |
| [dsh-genui](https://github.com/omdsh-dev/dsh-genui) | 241 | Interactive UI components rendered inline in replies: layout, charts, forms, quizzes, mermaid, 3D scenes, and an action event loop back to the model. | `dsh plugin add @omdsh-dev/dsh-genui` |
...
| [dsh-openpencil](https://github.com/ZSeven-W/dsh-openpencil) | 121 | OpenPencil design preview and editing plugin. | `dsh plugin add @zseven-w/dsh-openpencil` |
...
| Plugin | ⭐ | Description | Install |
|---|---|---|---|
| [dsh-TUI](https://github.com/ccch1mneyyy/dsh-TUI) | 2052 | Claude Code-style full-screen terminal UI: pixel-whale header, live status line, and streaming thought expansion. | `dsh plugin add dsh-cc-tui` |
| [dsh-tianshu-tui](https://github.com/huiliyi37/dsh-tianshu-tui) | 218 | A terminal UI (TUI) for DeepSeek Harness. | `dsh plugin add @huiliyi37/dsh-tianshu-tui` |
...
| [dsh-desktop](https://github.com/bruc3van/dsh-desktop) | 63 | Community-maintained unofficial desktop client (reuse official instance or built-in runtime) |  |
...
| [dsh-desktop](https://github.com/dataelement/dsh-desktop) | 1043 | Cross-platform desktop app |  |
...
| [deepseek-harness-desktop](https://github.com/anywhere-labs/deepseek-harness-desktop) | 14712 | Modern DeepSeek Harness desktop experience |  |
| [Deepseek-Harness-Desktop](https://github.com/ChisaAlter/Deepseek-Harness-Desktop) | 122 | Electron desktop shell with themes, wallpapers, and tray; chat stays on official dsh web | `dsh plugin add deepseek-harness-desktop` |
| [dsh-launcher](https://github.com/Ruler4396/dsh-launcher) | 153 | Lightweight Windows launcher: auto-start on boot + standalone small window |  |
| [dsh-work](https://github.com/vibeinging/deepseek-harness-desktop-app) | 489 | Local AI workspace: unified Session, files, data analysis, MCP, and Office |  |
...
| [deepseek-harness-tui](https://github.com/openma-ai/deepseek-harness-tui) | 43 | A Rust/ratatui terminal client that speaks the DSH SDK JSON-RPC protocol directly and runs standalone or as a profile bundle. | `dsh plugin add github:openma-ai/deepseek-harness-tui` |
...
| Plugin | ⭐ | Description | Install |
|---|---|---|---|
| [dsh-agent-teams](https://github.com/NanmiCoder/dsh-agent-teams) | 599 | AgentTeams multi-agent teams. | `dsh plugin add dsh-agent-teams` |
| [dsh_workflow](https://github.com/icetomoyo/dsh_workflow) | 86 | UltraCode-style multi-agent orchestration: a generatable, savable, governable, observable, resumable workflow layer. | `dsh plugin add @dsh-external/workflow` |
...
| Plugin | ⭐ | Description | Install |
|---|---|---|---|
| [dsh-memory-evolve](https://github.com/csyangwen/dsh-memory-evolve) | 190 | Cross-session long-term memory plus background self-evolution (five-track memory, git branch awareness, skill evolution) |  |
...
| [dsh-mnemon](https://github.com/omdsh-dev/dsh-mnemon) | 121 | Deep Mnemon integration: local three-tier memory (Runtime Memory, retrievable Documents, supervised Memory Spaces). | `dsh plugin add dsh-mnemon` |
...
| [dsh-meow-memory](https://github.com/Phant0Meow/dsh-meow-memory) | 15 | Cross-session project memory: layered SQLite storage with keyword/semantic retrieval, per-message hit injection and windowed consolidation. | `dsh plugin add github:Phant0Meow/dsh-meow-memory` |
...
| [dsh-context](https://github.com/bowenliang123/dsh-context) | 428 | Context insight panel: see what the model's context window is made of and how it evolves — composition vs. window size, per-request history, compression/injection events, and per-message token stats. | `dsh plugin add dsh-context` |
| [dsh-turn-rewind](https://github.com/Anionex/dsh-turn-rewind) | 87 | Rewind conversation and workspace state, powered by a persistent Change Ledger. | `dsh plugin add @dsh-external/turn-rewind` |
...
| [dsh-chat-import](https://github.com/Nwflower/dsh-chat-import) | 72 | Import full-fidelity chat histories from 13 coding agents (Claude Code, Codex, ChatGPT, Cursor, Gemini, opencode, and more) as resumable DeepSeek Harness sessions, with reverse export back to Claude Code. | `dsh plugin add dsh-chat-import` |
...
| Plugin | ⭐ | Description | Install |
|---|---|---|---|
| [modlens](https://github.com/liustack/modlens) | 3229 | Vision bridge for text-only models: paste an image, get structured JSON evidence (OCR, layout, semantics). | `dsh plugin add @liustack/modlens` |
| [dsh-vision-toolkit](https://github.com/Anionex/dsh-vision-toolkit) | 741 | Vision tasks for text-only models: intent-aware image Q&A, long-screenshot OCR, UI reproduction, grounding, and pixel diff. | `dsh plugin add @dsh-external/dsh-vision-toolkit` |
| [agent-vision-toolkit](https://github.com/Anionex/agent-vision-toolkit) | 1060 | General agent vision toolkit and skills (multi-image understanding and GUI automation) |  |
| [dsh-vision](https://github.com/william-jin-cmu/dsh-vision) | 35 | view_image tool bridging any OpenAI-compatible VLM (defaults to Zhipu's free tier) |  |
...
| [dsh-vision-router](https://github.com/ysr666/dsh-vision-router) | 813 | Free vision for text-only agents: built-in keyless vision chain plus pixel tools (Q&A, grounding, crop, pixel diff, colors, OCR, SVG trace, cutout, screenshots); paste an image to use it. | `dsh plugin add dsh-vision-router` |
...
| [dsh-automation](https://github.com/titanwings/dsh-automation) | 65 | Scheduled coding runs in fresh agent sessions with auditable history. | `dsh plugin add @dsh-external/dsh-automation` |
...
| [mstar-harness](https://github.com/btspoony/mstar-harness) | 50 | Skill-driven harness/loop engineering workflow agent plugin. |  |
...
| [dsh-record-replay](https://github.com/humblebanana/dsh-record-replay) | 10 | Record macOS desktop workflow demos and convert them into agent skills (orr_* tools) | `dsh plugin add dsh-record-replay` |
...
| [dsh-im](https://github.com/xmanrui/dsh-im) | 67 | One settings entry to connect Feishu/WeChat/DingTalk/WeCom/QQ/Slack/Telegram/Discord/WhatsApp bots via QR scan, App Manifest or credentials. |  |
| [dsh-notification](https://github.com/omdsh-dev/dsh-notification) | 65 | Desktop notifications for turn completions, with per-outcome controls and keyword rules. | `dsh plugin add dsh-notification` |
...
| [dsh-open-in-vscode](https://github.com/omdsh-dev/dsh-open-in-vscode) | 52 | Open DSH workspace directories in VS Code directly from the web GUI. | `dsh plugin add dsh-open-in-vscode` |
...
| Plugin | ⭐ | Description | Install |
|---|---|---|---|
| [dsh-browser](https://github.com/Lum1104/dsh-browser) | 318 | Chrome sidebar extension that lets DSH operate your browser directly, no vision capabilities required. |  |
...
| [deepseek-pp](https://github.com/zhu1090093659/deepseek-pp) | 1625 | Browser-extension AI agent workspace with built-in MCP and memory |  |
...
| [dsh-tavily-search](https://github.com/zhouzhencheng07/dsh-tavily-search) | 3 | Key-free Tavily search tool | `dsh plugin add dsh-tavily-search` |
...
| [modsearch](https://github.com/liustack/modsearch) | 166 | Web search bridge for text-only agents: ask the web or X, get structured JSON evidence (search, fetch, citations). | `dsh plugin add @liustack/modsearch` |
...
| [dsh-super-injector](https://github.com/yjh051108/dsh-super-injector) | 121 | Super module injector: inject local plugin packages at runtime (junction + loader.create, hot reload). | `dsh plugin add @dsh-external/dsh-super-injector` |
...
| [deepseek-harness-docker](https://github.com/runzhliu/deepseek-harness-docker) | 23 | Community Docker/K8s packaging (hardened image + Compose + Helm). |  |
...
| [dsh-multica-runtime](https://github.com/multica-ai/dsh-multica-runtime) | 52 | Multica DSH runtime bridge (stdio JSONL protocol). | `dsh plugin add @multica-ai/dsh-runtime` |
...
| [dsh-market](https://github.com/dsh-market/dsh-market) | 1188 | The plugin market inside DSH: a Settings page to browse and search the full community catalog by category, with confirmed one-click installs and an installed-plugins view. | `dsh plugin add github:dsh-market/dsh-market` |
| [dsh-webui-market-plugin](https://github.com/Sanqi-normal/dsh-webui-market-plugin) | 89 | In-harness plugin market for the dsh web GUI: browse the awesome-dsh-plugin.com catalog and install/uninstall plugins into a profile from Settings → Plugins → Plugin Market. | `dsh plugin add github:Sanqi-normal/dsh-webui-market-plugin` |
...
| [whale-girl](https://github.com/vlln/whale-girl) | 245 | Desktop pet (QQ-pet style): floats in the corner, draggable, feedable, playable. | `dsh plugin add whale-girl` |
...
| [dsh-emoji](https://github.com/hellodigua/dsh-emoji) | 30 | Automatically add emojis to AI replies. | `dsh plugin add @dsh-external/dsh-emoji` |
| [dsh-ads](https://github.com/Nagi-ovo/dsh-ads) | 510 | Parody ads in 2005-Chinese-web style: sidebar banners, in-chat feeds, corner popups, and a close button whose hit area is smaller than it looks. All fictional. | `dsh plugin add @dsh-external/dsh-ads` |
...
| [dsh-toy](https://github.com/c3ll256/dsh-toy) | 57 | Connect small toys to DSH (Toy Control Protocol). | `dsh plugin add dsh-toy` |
...
| [dsh-cost-meter](https://github.com/Han-1413141/dsh-cost-meter) | 108 | Per-session and daily API cost, budget with usage %, official balance, history dashboard, and one-click official price sync with peak/off-peak pricing. | `dsh plugin add github:Han-1413141/dsh-cost-meter` |
...
| Plugin | ⭐ | Description | Install |
|---|---|---|---|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | 164986 | Official core repo: "everything is a plugin", driven by Cordis. |  |
| [deepseek-ai/awesome-deepseek-agent](https://github.com/deepseek-ai/awesome-deepseek-agent) | 5949 | Official curated list of DeepSeek agents. |  |
| [awesome-dsh-plugin/awesome-dsh-plugin](https://github.com/awesome-dsh-plugin/awesome-dsh-plugin) | 9786 | Community curated list (105 plugins + sites + badges). |  |
| [bruc3van/awesome-dsh-plugin](https://github.com/bruc3van/awesome-dsh-plugin) | 244 | "Find your plugin in 30 seconds", with scenario descriptions and a 505-plugin snapshot. |  |
| [0xsline/awesome-deepseek-harness](https://github.com/0xsline/awesome-deepseek-harness) | 744 | Curated DSH ecosystem: plugins, tools, and infrastructure. |  |
| [AdamPlatin123/awesome-dsh-plugins](https://github.com/AdamPlatin123/awesome-dsh-plugins) | 1242 | Catalog plus a daily compatibility radar (four-dimension checks + live tests). |  |
| [Alex-Yanggg/awesome-DSH-plugin](https://github.com/Alex-Yanggg/awesome-DSH-plugin) | 73 | Categorized catalog covering productivity, extensions, debugging, and custom development. |  |
