...
| # | Plugin | Description | ⭐ |
|---|---|---|---|
| 🥇 | [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | Official core repo: "everything is a plugin", driven by Cordis. | 122776 |
| 🥈 | [deepseek-harness-desktop](https://github.com/anywhere-labs/deepseek-harness-desktop) | Modern DeepSeek Harness desktop experience | 7505 |
...
| 4 | [awesome-dsh-plugin/awesome-dsh-plugin](https://github.com/awesome-dsh-plugin/awesome-dsh-plugin) | Community curated list (105 plugins + sites + badges). | 3729 |
| 5 | [dsh-web-ui](https://github.com/zhu1090093659/dsh-web-ui) | DSH Web UI plugin and skin collection: task board, Git graph, right panel, mobile remote, skin center | 3048 |
| 6 | [modlens](https://github.com/liustack/modlens) | Vision bridge for text-only models: paste an image, get structured JSON evidence (OCR, layout, semantics). | 2126 |
| 7 | [deepseek-pp](https://github.com/zhu1090093659/deepseek-pp) | Browser-extension AI agent workspace with built-in MCP and memory | 1564 |
| 8 | [DSH-better-sidebar](https://github.com/omdsh-dev/DSH-better-sidebar) | Full sidebar workbench with file rendering and editing, terminal, Git, and subagents; third-party plugins can register new tabs. | 1439 |
| 9 | [dsh-TUI](https://github.com/ccch1mneyyy/dsh-TUI) | Claude Code-style full-screen terminal UI: pixel-whale header, live status line, and streaming thought expansion. | 1401 |
| 10 | [AdamPlatin123/awesome-dsh-plugins](https://github.com/AdamPlatin123/awesome-dsh-plugins) | Catalog plus a daily compatibility radar (four-dimension checks + live tests). | 1012 |
...
| [dsh-tool-stat](https://github.com/omdsh-dev/dsh-tool-stat) | 4 | Descriptive statistics, percentiles, frequency distributions, and correlation. | `dsh plugin add @deepseek-ai/dsh-tool-stat` |
...
| [dsh-at-file](https://github.com/omdsh-dev/dsh-at-file) | 241 | Codex-style `@file` mentions: search workspace files in the composer and attach their contents to prompts. | `dsh plugin add dsh-at-file` |
...
| [dsh-find-plugins](https://github.com/Nagi-ovo/dsh-find-plugins) | 116 | Skill that searches, installs, and verifies GitHub plugins for DSH | `dsh plugin add github:Nagi-ovo/dsh-find-plugins` |
...
| Plugin | ⭐ | Description | Install |
|---|---|---|---|
| [dsh-mcp-manager](https://github.com/hyqhyq3/dsh-mcp-manager) | 6 | MCP server management: OAuth (PKCE) or static token auth via Settings, tools registered as `mcp__*` | `dsh plugin add dsh-mcp-manager` |
...
| [dsh-deep-whale](https://github.com/Small-tailqwq/dsh-deep-whale) | 982 | Whale-girl skin series for the DSH Web UI (maid-atelier). |  |
...
| [DSH-better-sidebar](https://github.com/omdsh-dev/DSH-better-sidebar) | 1439 | Full sidebar workbench with file rendering and editing, terminal, Git, and subagents; third-party plugins can register new tabs. | `dsh plugin add dsh-better-sidebar` |
...
| [dsh-navbar](https://github.com/vlln/dsh-navbar) | 25 | Conversation node navigation bar for quick jumps between user messages. | `dsh plugin add @dsh-external/dsh-navbar` |
...
| [dsh-drag-and-drop](https://github.com/bill9109/dsh-drag-and-drop) | 11 | Cross-platform file drag-and-drop with raw path insertion, no file copying. | `dsh plugin add @bill9109/dsh-drag-and-drop` |
...
| [dsh-web-ui](https://github.com/zhu1090093659/dsh-web-ui) | 3048 | DSH Web UI plugin and skin collection: task board, Git graph, right panel, mobile remote, skin center | `dsh plugin add dsh-web-ui` |
...
| [dsh-visualize](https://github.com/Nagi-ovo/dsh-visualize) | 138 | In-conversation generative UI: the model renders interactive HTML cards into the chat stream, with streaming preview and sandboxed rendering. | `dsh plugin add @dsh-external/dsh-visualize` |
| [dsh-genui](https://github.com/omdsh-dev/dsh-genui) | 120 | Interactive UI components rendered inline in replies: layout, charts, forms, quizzes, mermaid, 3D scenes, and an action event loop back to the model. | `dsh plugin add @omdsh-dev/dsh-genui` |
...
| [dsh-openpencil](https://github.com/ZSeven-W/dsh-openpencil) | 92 | OpenPencil design preview and editing plugin. | `dsh plugin add @zseven-w/dsh-openpencil` |
...
| Plugin | ⭐ | Description | Install |
|---|---|---|---|
| [dsh-TUI](https://github.com/ccch1mneyyy/dsh-TUI) | 1401 | Claude Code-style full-screen terminal UI: pixel-whale header, live status line, and streaming thought expansion. | `dsh plugin add dsh-cc-tui` |
| [dsh-tianshu-tui](https://github.com/huiliyi37/dsh-tianshu-tui) | 182 | A terminal UI (TUI) for DeepSeek Harness. | `dsh plugin add @huiliyi37/dsh-tianshu-tui` |
...
| [oh-dsh](https://github.com/hust-open-atom-club/oh-dsh) | 207 | Community distribution: TUI, desktop, and Web UI as one bundle with layered installation. | `dsh plugin add @oh-dsh/desktop` |
...
| [dsh-desktop](https://github.com/bruc3van/dsh-desktop) | 40 | Community-maintained unofficial desktop client (reuse official instance or built-in runtime) |  |
...
| [dsh-desktop](https://github.com/dataelement/dsh-desktop) | 399 | Cross-platform desktop app |  |
...
| [deepseek-harness-desktop](https://github.com/anywhere-labs/deepseek-harness-desktop) | 7505 | Modern DeepSeek Harness desktop experience |  |
| [Deepseek-Harness-Desktop](https://github.com/ChisaAlter/Deepseek-Harness-Desktop) | 92 | Electron desktop shell with themes, wallpapers, and tray; chat stays on official dsh web | `dsh plugin add deepseek-harness-desktop` |
| [dsh-launcher](https://github.com/Ruler4396/dsh-launcher) | 117 | Lightweight Windows launcher: auto-start on boot + standalone small window |  |
| [dsh-work](https://github.com/vibeinging/deepseek-harness-desktop-app) | 208 | Local AI workspace: unified Session, files, data analysis, MCP, and Office |  |
...
| [deepseek-harness-tui](https://github.com/openma-ai/deepseek-harness-tui) | 28 | A Rust/ratatui terminal client that speaks the DSH SDK JSON-RPC protocol directly and runs standalone or as a profile bundle. | `dsh plugin add github:openma-ai/deepseek-harness-tui` |
...
| Plugin | ⭐ | Description | Install |
|---|---|---|---|
| [dsh-agent-teams](https://github.com/NanmiCoder/dsh-agent-teams) | 374 | AgentTeams multi-agent teams. | `dsh plugin add dsh-agent-teams` |
| [dsh_workflow](https://github.com/icetomoyo/dsh_workflow) | 61 | UltraCode-style multi-agent orchestration: a generatable, savable, governable, observable, resumable workflow layer. | `dsh plugin add @dsh-external/workflow` |
...
| Plugin | ⭐ | Description | Install |
|---|---|---|---|
| [dsh-memory-evolve](https://github.com/csyangwen/dsh-memory-evolve) | 103 | Cross-session long-term memory plus background self-evolution (five-track memory, git branch awareness, skill evolution) |  |
...
| [dsh-mnemon](https://github.com/omdsh-dev/dsh-mnemon) | 43 | Deep Mnemon integration: local three-tier memory (Runtime Memory, retrievable Documents, supervised Memory Spaces). | `dsh plugin add dsh-mnemon` |
...
| [dsh-continual-evolve](https://github.com/ZK-Andy/dsh-continual-evolve) | 7 | Continual self-evolution: versioned, auditable, rollback-safe harness state (prompts, memory, skills, subagent specs) refined from session trajectories, with review gates and hot-reloaded skills. | `dsh plugin add dsh-continual-evolve` |
...
| [dsh-context](https://github.com/bowenliang123/dsh-context) | 45 | Context insight panel: see what the model's context window is made of and how it evolves — composition vs. window size, per-request history, compression/injection events, and per-message token stats. | `dsh plugin add dsh-context` |
| [dsh-turn-rewind](https://github.com/Anionex/dsh-turn-rewind) | 61 | Rewind conversation and workspace state, powered by a persistent Change Ledger. | `dsh plugin add @dsh-external/turn-rewind` |
...
| [dsh-chat-import](https://github.com/Nwflower/dsh-chat-import) | 41 | Import full-fidelity chat histories from 13 coding agents (Claude Code, Codex, ChatGPT, Cursor, Gemini, opencode, and more) as resumable DeepSeek Harness sessions, with reverse export back to Claude Code. | `dsh plugin add dsh-chat-import` |
...
| Plugin | ⭐ | Description | Install |
|---|---|---|---|
| [modlens](https://github.com/liustack/modlens) | 2126 | Vision bridge for text-only models: paste an image, get structured JSON evidence (OCR, layout, semantics). | `dsh plugin add @liustack/modlens` |
| [dsh-vision-toolkit](https://github.com/Anionex/dsh-vision-toolkit) | 476 | Vision tasks for text-only models: intent-aware image Q&A, long-screenshot OCR, UI reproduction, grounding, and pixel diff. | `dsh plugin add @dsh-external/dsh-vision-toolkit` |
| [agent-vision-toolkit](https://github.com/Anionex/agent-vision-toolkit) | 926 | General agent vision toolkit and skills (multi-image understanding and GUI automation) |  |
| [dsh-vision](https://github.com/william-jin-cmu/dsh-vision) | 28 | view_image tool bridging any OpenAI-compatible VLM (defaults to Zhipu's free tier) |  |
...
| [dsh-vision-router](https://github.com/ysr666/dsh-vision-router) | 266 | Free vision for text-only agents: built-in keyless vision chain plus pixel tools (Q&A, grounding, crop, pixel diff, colors, OCR, SVG trace, cutout, screenshots); paste an image to use it. | `dsh plugin add dsh-vision-router` |
...
| [dsh-chatnode-wechat](https://github.com/Jesse-njx/dsh-chatnode-wechat) | 4 | Chat with, monitor, and approve your DSH agents from WeChat via the iLink gateway: text both ways, session targeting, digest heartbeats, and numbered approval prompts. | `dsh plugin add @dsh-cowork/chatnode-wechat` |
...
| Plugin | ⭐ | Description | Install |
|---|---|---|---|
| [dsh-browser](https://github.com/Lum1104/dsh-browser) | 179 | Chrome sidebar extension that lets DSH operate your browser directly, no vision capabilities required. |  |
...
| [deepseek-pp](https://github.com/zhu1090093659/deepseek-pp) | 1564 | Browser-extension AI agent workspace with built-in MCP and memory |  |
...
| [modsearch](https://github.com/liustack/modsearch) | 106 | Web search bridge for text-only agents: ask the web or X, get structured JSON evidence (search, fetch, citations). | `dsh plugin add @liustack/modsearch` |
| [argo](https://github.com/taxueseek/argo) | 87 | Search built for agents: multilingual coverage across web, academic, code, shopping, finance, news, and encyclopedias. | `dsh plugin add github:taxueseek/argo` |
...
| Plugin | ⭐ | Description | Install |
|---|---|---|---|
| [plugin-registry](https://github.com/vlln/plugin-registry) | 45 | Ecosystem infrastructure: a thin browser console for managing official repository plugins (zero patches) plus a make-dsh-plugin skill for guided plugin development. |  |
...
| [dsh-super-injector](https://github.com/yjh051108/dsh-super-injector) | 80 | Super module injector: inject local plugin packages at runtime (junction + loader.create, hot reload). | `dsh plugin add @dsh-external/dsh-super-injector` |
| [oh-my-dsh](https://github.com/LaplaceYoung/oh-my-dsh) | 47 | Plugin ecosystem for DSH: 700+ plugins with extension seams registered without touching the agent loop. |  |
| [dsh-plugin-check](https://github.com/omdsh-dev/dsh-plugin-check) | 21 | Plugin health checks: manifest protocol / patch format / build traps, zero-dependency and read-only. | `dsh plugin add @deepseek-ai/dsh-plugin-check` |
...
| [dsh-evolve](https://github.com/william-jin-cmu/dsh-evolve) | 6 | Self-evolution: the agent hot-mounts/removes persistent plugins on itself mid-session. | `dsh plugin add @dsh-external/dsh-evolve` |
...
| [dsh-tool-policy](https://github.com/Drifter-yh/dsh-tool-policy) | 2 | Declarative default-deny tool policy. | `dsh plugin add dsh-tool-policy` |
...
| [deepseek-harness-docker](https://github.com/runzhliu/deepseek-harness-docker) | 11 | Community Docker/K8s packaging (hardened image + Compose + Helm). |  |
| [dsh-harness-ops](https://github.com/fakechris/dsh-harness-ops) | 10 | Ops toolkit: A/B dual-slot snapshot upgrades, auto-recovery, rollback, and self-healing diagnostics. |  |
...
| [dsh-market](https://github.com/dsh-market/dsh-market) | 414 | The plugin market inside DSH: a Settings page to browse and search the full community catalog by category, with confirmed one-click installs and an installed-plugins view. | `dsh plugin add github:dsh-market/dsh-market` |
| [dsh-webui-market-plugin](https://github.com/Sanqi-normal/dsh-webui-market-plugin) | 60 | In-harness plugin market for the dsh web GUI: browse the awesome-dsh-plugin.com catalog and install/uninstall plugins into a profile from Settings → Plugins → Plugin Market. | `dsh plugin add github:Sanqi-normal/dsh-webui-market-plugin` |
...
| [dsh-minigames](https://github.com/lhh010/dsh-minigames) | 18 | Side-panel arcade: 18 offline mini-games to play while the model thinks. | `dsh plugin add @dsh-external/dsh-minigames` |
...
| [whale-girl](https://github.com/vlln/whale-girl) | 182 | Desktop pet (QQ-pet style): floats in the corner, draggable, feedable, playable. | `dsh plugin add whale-girl` |
...
| [deepseek-pet](https://github.com/keleus/deepseek-pet) | 25 | Keep a big blue whale pet in DSH. | `dsh plugin add deepseek-pet` |
...
| [dsh-ads](https://github.com/Nagi-ovo/dsh-ads) | 437 | Parody ads in 2005-Chinese-web style: sidebar banners, in-chat feeds, corner popups, and a close button whose hit area is smaller than it looks. All fictional. | `dsh plugin add @dsh-external/dsh-ads` |
...
| [dsh-toy](https://github.com/c3ll256/dsh-toy) | 50 | Connect small toys to DSH (Toy Control Protocol). | `dsh plugin add dsh-toy` |
...
| [dsh-openmaic](https://github.com/THU-MAIC/dsh-openmaic) | 8 | OpenMAIC: classrooms, slides, interactive widgets, and Socratic teaching. | `dsh plugin add @openmaic/dsh-openmaic` |
...
| [dsh-cost-meter](https://github.com/Han-1413141/dsh-cost-meter) | 40 | Per-session and daily API cost, budget with usage %, official balance, history dashboard, and one-click official price sync with peak/off-peak pricing. | `dsh plugin add github:Han-1413141/dsh-cost-meter` |
...
| Plugin | ⭐ | Description | Install |
|---|---|---|---|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | 122776 | Official core repo: "everything is a plugin", driven by Cordis. |  |
...
| [awesome-dsh-plugin/awesome-dsh-plugin](https://github.com/awesome-dsh-plugin/awesome-dsh-plugin) | 3729 | Community curated list (105 plugins + sites + badges). |  |
| [bruc3van/awesome-dsh-plugin](https://github.com/bruc3van/awesome-dsh-plugin) | 164 | "Find your plugin in 30 seconds", with scenario descriptions and a 505-plugin snapshot. |  |
| [0xsline/awesome-deepseek-harness](https://github.com/0xsline/awesome-deepseek-harness) | 543 | Curated DSH ecosystem: plugins, tools, and infrastructure. |  |
| [AdamPlatin123/awesome-dsh-plugins](https://github.com/AdamPlatin123/awesome-dsh-plugins) | 1012 | Catalog plus a daily compatibility radar (four-dimension checks + live tests). |  |
